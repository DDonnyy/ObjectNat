...
1. **[Изохроны и транспортная доступность](docs/examples/isochrone_generator.ipynb)** — Изохроны представляют собой области,
...
2. **[Зоны покрытия](docs/examples/graph_coverage.ipynb)** — Функция генерации **зон покрытия** от набора исходных точек
...
3. **[Анализ обеспеченности сервисами](docs/examples/calculate_provision.ipynb)** — Функция оценки обеспеченности жилых зданий
...
4. **[Анализ видимости](docs/examples/visibility_analysis.ipynb)** — Функция оценки видимости от заданной точки или множества
...
5. **[Моделирование шума](docs/examples/noise_simulation.ipynb)** — Симуляция распространения шума от источников с учётом **препятствий**,
...
6. **[Кластеризация точек](docs/examples/point_clusterization.ipynb)** — Функция построения **кластерных полигонов** по множеству точек на основе:
